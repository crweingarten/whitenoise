...
export default function About({ navigation }) {
  ...
  return (
      <View style={styles.container}>
        ...
        <Text style={styles.copy}>fuzzzel is a bespoke ios white noise app and the world's first artist-centered white noise record label.</Text>
